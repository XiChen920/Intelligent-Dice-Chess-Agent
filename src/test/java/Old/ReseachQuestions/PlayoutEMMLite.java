...
public class PlayoutEMMLite
{
    ...
    String fileName = "EMM_vs_Baseline_lite";
    //Heading per logged game
    String[] csvHeadings = new String[]{"Game count", "Winner", "Game duration", "Number of moves", "EMM dept"};

    public static void main(String[] args)
    {
        PlayoutEMMLite experiment = new PlayoutEMMLite("ExpectiMiniMax", "Baseline");
    }

    public PlayoutEMMLite(String agent_1_type, String agent_2_type)
    {
        currentGame = 0;
