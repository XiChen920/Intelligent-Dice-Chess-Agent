...
public class PlayoutEMMABP
{
    ...
    String fileName = "EMMABP_vs_Baseline";
    //Heading per logged game
    String[] csvHeadings = new String[]{"Game count", "Winner", "Game duration", "Number of moves", "EMM dept"};

    public static void main(String[] args)
    {
        PlayoutEMMABP experiment = new PlayoutEMMABP("ExpextiMiniMaxAlphaBetaPruning", "Baseline");
    }

    public PlayoutEMMABP(String agent_1_type, String agent_2_type)
    {
        currentGame = 0;
